...
def simulation_with_diffrent_distributions(list_num_items_capacity: list, list_num_agents: list, divide_type='default'):
    ...
    for num_agents, item_capacity in zip(list_num_agents, list_num_items_capacity):
        ...
        if divide_type == 'default':
            ...
            alloc_cm = main_course_match_p.course_match_algorithm( AllocationBuilder(random_instance), budget) #divide(algorithm=main_course_match_p.course_match_algorithm, instance=random_instance, budget=budget)
            ...
            alloc_cm = main_course_match_p.course_match_algorithm( AllocationBuilder(random_instance), budget) #divide(algorithm=main_course_match_p.course_match_algorithm, instance=random_instance, budget=budget, priorities_student_list=priorities_list)
